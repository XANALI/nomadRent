# Generated by Django 2.2.6 on 2019-12-08 11:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userImg', models.ImageField(default='user_avas/default.jpg', upload_to='user_avas/')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(blank=True, null=True, verbose_name='starting date')),
                ('end_date', models.DateTimeField(blank=True, null=True, verbose_name='ending date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('modelImg', models.ImageField(default='/static/car/car-default.jpg', upload_to='car_pictures/')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('bank_card_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ourApp.BankCard')),
                ('car_id', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='ourApp.Car')),
                ('license_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ourApp.DriverLicense')),
